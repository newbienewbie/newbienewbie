...
namespace Microsoft.AspNetCore.StaticFiles
{
    ...
    /// </summary>
    public class MyDefaultFilesMiddleware
    {
        ...
        public MyDefaultFilesMiddleware(RequestDelegate next, IHostingEnvironment hostingEnv, IOptions<DefaultFilesOptions> options)
        {
            if (next == null)
            {
